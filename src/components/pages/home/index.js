...
function Home() {
  const [product, setProduct] = useState([
    ...
    },
    {
      id: "49538094",
      title:
        "Kenwood kMix Stand Mixer for Baking, Stylish Kitchen Mixer with K-beater, 5 Litre Glass Bowl",
      price: 239.0,
      rating: 4,
      image:
  ...
  return (
    <>
      <Header product={product} setSearch={setSearch} />
      <div className="home">
        <div className="home-container">
          <img
            className="home-image"
            src="https://i.hizliresim.com/rgiiz4d.jpg"
            alt=""
          />
